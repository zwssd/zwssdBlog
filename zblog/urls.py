...
urlpatterns = [
    ...
    url(r'^login/$',
        TemplateView.as_view(template_name="zuser/login.html"),
        name='login-view'),
    url(r'^register/$',
        TemplateView.as_view(template_name="zuser/register.html"),
        name='register-view'),
    url(r'^forgetpassword/$',
        TemplateView.as_view(template_name="zuser/forgetpassword.html"),
        name='forgetpassword-view'),
    url(r'^resetpassword/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$',
        TemplateView.as_view(template_name="zuser/resetpassword.html"),
